...
from .views import ProductosView, CategoriasView, ActualizarCategproasView, OrdenesView
urlpatterns = [
    ...
    path('categorias/actualizar/<int:categoria_id>',
         ActualizarCategproasView.as_view()),
